...
export const AFTER_SCHOOL_STORY_ARCS = Object.freeze([
  ...
  },
  {
    ...
    summary: '主人公以外にも英語を覚える生徒が見つかり、調査ノートを共有する。',
    investigation: 'それぞれが覚えている単語と、忘れた場面を照合する。',
  ...
  },
  {
    ...
    nextLead: '五地点の単語と熟語・構文をすべて戻せば、世界の記憶が正常化する。',
  },
  {
    id: 'restore-everyday-life', number: 11,
    title: '五地点の正常化と1級EXTRA', shortTitle: '記憶の復帰',
    summary: '五地点が正常化すると、英語が日常に戻り、学校の記憶庫に1級EXTRAが開く。',
    investigation: '先生と生徒が各地の200断片を照合し、龍脈へ正しい英語を紡ぎ込む。',
