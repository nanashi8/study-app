...
export const MOB_PROFILES = {
  ...
  'echo-owl': mob(4, 0, '響梟族', '反響型', '音', 'エコー・テスト', '聞こえた語を似た響きで何度も返す', '森の会話を一字も忘れない。敵か先生かは答え方しだい。'),
...
const teacherRival = ({
  ...
  intent: `${subject}の文脈と英語の記憶断片を比べる`,
  lore,
...
export const TEACHER_RIVALS = {
  ...
  leviathan: teacherRival({
    ...
    lore: '例文の国や文化まで教えてくれる先生。地球儀が止まった場所からテストが始まる。',
  ...
  'word-emperor': teacherRival({
    ...
    intent: '出来事の順番と因果関係を、出席簿を確かめるように比べる',
