...
const READING_BINDING_EXPECTATIONS = new Map([
  ...
  ['Setting review dates and publishing results allow governments to revise policies without treating revision as failure.|||treating', { ingBinding: { type: 'preposition-gerund', governor: 'without', semanticSubject: 'governments' } }],
  ...
  ['Setting review dates and publishing results allow governments to revise policies without treating revision as failure.|||and', { coordinationBinding: { type: 'compound-gerund-subject', left: 'Setting review dates', right: 'publishing results', governor: 'allow' } }],
...
const READING_SEQUENCE_EXPECTATIONS = new Map([
  ...
  ['Setting review dates and publishing results allow governments to revise policies without treating revision as failure.', [
    ...
    ['allow', 'V'], ['governments', 'O'], ['to revise', 'V'], ['policies', 'O'],
...
const LONG_BINDING_EXPECTATIONS = new Map([
  ...
  ['curr_syn_gr_auto_pre1_agreement_001|||one of the reviews', { role: 'S', agreementBinding: { type: 'head-noun-agreement', controller: 'One', number: 'singular' } }],
  ['curr_syn_gr_auto_pre1_agreement_002|||one of the reviews', { role: 'S', agreementBinding: { type: 'head-noun-agreement', controller: 'One', number: 'singular' } }],
  ...
  ['curr_syn_gr_auto_pre1_agreement_001|||to help', { infinitiveBinding: { type: 'passive-verb-complement', governor: 'is expected', semanticSubject: 'One of the reviews' } }],
  ...
  ['curr_syn_gr_auto_pre1_agreement_002|||to help', { infinitiveBinding: { type: 'passive-verb-complement', governor: 'is expected', semanticSubject: 'One of the reviews' } }],
