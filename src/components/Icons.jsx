...
export const Menu = (p) => base(<><path d="M4 6h16" /><path d="M4 12h16" /><path d="M4 18h16" /></>, { ...p, strokeWidth: 2.4 })
export const Lock = (p) => base(<><rect x="5" y="10" width="14" height="10" rx="2" /><path d="M8 10V7a4 4 0 0 1 8 0v3" /><path d="M12 14v2" /></>, p)
...
export const Play = (p) => base(<path d="m8 5 11 7-11 7z" />, { ...p, fill: 'currentColor', strokeWidth: 1.5 })
export const Pause = (p) => base(<><path d="M8 5v14" /><path d="M16 5v14" /></>, { ...p, strokeWidth: 3 })
export const Stop = (p) => base(<rect x="6" y="6" width="12" height="12" rx="1" />, { ...p, fill: 'currentColor', strokeWidth: 1.5 })
...
export const Teacher = (p) => base(<><rect x="3" y="4" width="18" height="13" rx="2" /><path d="M7 8h5M7 11h3" /><circle cx="16.5" cy="9" r="2" /><path d="M13.5 16c.4-2.5 1.4-4 3-4s2.6 1.5 3 4" /><path d="M9 21h6M12 17v4" /></>, p)
