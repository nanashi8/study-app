        ...
        {levels.map((l) => {
          ...
          return (
            <button
              ...
              className="w-full rounded-2xl bg-white p-3.5 text-left shadow-card active:scale-[0.98] transition-transform disabled:opacity-45 disabled:active:scale-100"
            >
