...
import { getEnglishVoices, subscribeVoices, speak, isTTSSupported } from '../lib/tts.js'
...
export function SettingsScreen() {
  ...
  useEffect(() => subscribeVoices(() => setVoices(getEnglishVoices())), [])
      ...
      <div className="space-y-4 px-4">
        ...
        <Card className="px-4">
          ...
          <div className="divide-y divide-brand-50">
            ...
            <Row title="英語の声" desc="端末にある音声から選べます">
              <select
                value={settings.ttsVoiceURI ?? ''}
                onChange={(e) => setSetting('ttsVoiceURI', e.target.value || null)}
