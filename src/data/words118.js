...
const RAW = [
  ...
  ['sprain', '動', '2', 'ねんざする・くじき', 'Riko sprained her ankle while playing basketball.', 'リコはバスケットボールをしていて足首をねんざした。', '古フランス espraindre(締めつける)。', { syn: [{ w: 'twist', m: 'ひねる' }, { w: 'wrench', m: 'くじく' }], field: '医学' }],
  ...
  ['vomit', '動', '2', '吐く・嘔吐する', 'The boy got seasick and vomited over the side of the boat.', 'その男の子は船酔いして、船べりから吐いた。', 'ラテン vomere(吐く)。', { syn: [{ w: 'throw up', m: '吐く' }, { w: 'regurgitate', m: '吐き戻す' }], ant: [{ w: 'swallow', m: '飲み込む' }], field: '医学' }],
  ...
  ['sentence', '名', 'pre1', '文', 'Write one sentence about your weekend.', '週末について1文書きなさい。', 'ラテン sententia(意見)→ sentiment と同系。', { syn: [{ w: 'condemn', m: '宣告する' }, { w: 'convict', m: '有罪にする' }], ant: [{ w: 'acquit', m: '無罪にする' }], field: '法律' }],
  ...
  ['upload', '動', '2', 'アップロードする・転送する', 'Please upload your homework to the class website by Friday.', '金曜日までに宿題をクラスのウェブサイトにアップロードしてください。', 'up(上へ)+load(積む)。', { syn: [{ w: 'transfer', m: '転送する' }, { w: 'post', m: '投稿する' }], ant: [{ w: 'download', m: 'ダウンロードする' }], field: '技術' }],
  ['browse', '動', '2', '拾い読みする・閲覧する・(草を)食べる', 'I often browse through magazines while waiting at the hair salon.', '美容院で待つ間、よく雑誌を拾い読みする。', '古フランス brouster(若芽を食う)。', { syn: [{ w: 'skim', m: '拾い読みする' }, { w: 'surf', m: 'ネットサーフィンする' }], fam: [{ w: 'browser', m: 'ブラウザー' }], field: '技術' }],
  ...
  ['scroll', '動', '2', 'スクロールする・巻物', 'Scroll down to the bottom of the page to find the address.', '住所を見つけるには、ページのいちばん下までスクロールしてください。', '中英語 scrowle(巻物)。', { syn: [{ w: 'roll', m: '巻く' }], field: '技術' }],
  ['hack', '動', '2', '不正侵入する・たたき切る', "Someone hacked the school's website and changed the homepage.", '何者かが学校のウェブサイトに不正侵入し、トップページを書き換えた。', '古英語 haccian(切り刻む)。', { syn: [{ w: 'breach', m: '侵入する' }, { w: 'chop', m: 'たたき切る' }], fam: [{ w: 'hacker', m: 'ハッカー' }], field: '技術' }],
  ['debug', '動', '2', 'バグを取り除く・修正する', 'The programmer spent the whole night debugging the new game.', 'そのプログラマーは新しいゲームのバグを取り除くのに一晩中かかった。', 'de(除去)+bug(虫・不具合)。', { syn: [{ w: 'fix', m: '修正する' }, { w: 'troubleshoot', m: '不具合を解消する' }], field: '技術' }],
  ['elect', '動', 'pre1', '選出する・選ぶ', 'Our class will elect a new student council member next week.', '私たちのクラスは来週、新しい生徒会の委員を選出する。', 'ラテン eligere(選び出す)→ select と同系。', { syn: [{ w: 'choose', m: '選ぶ' }, { w: 'vote in', m: '選挙で選ぶ' }], ant: [{ w: 'oust', m: '追放する' }], fam: [{ w: 'election', m: '選挙' }], field: '政治' }],
  ...
  ['graze', '動', '2', '草を食む・放牧する・かすめる', 'Sheep were grazing peacefully on the hillside.', '羊たちが丘の斜面でのんびりと草を食んでいた。', '古英語 grasian(草を食う)→ grass と同系。', { syn: [{ w: 'feed', m: '食べる' }, { w: 'pasture', m: '放牧する' }], field: '農業' }],
  ['sow', '動', '2', '(種を)まく・植えつける', 'In April, the farmers sow seeds in their vegetable fields.', '4月になると、農家の人たちは野菜畑に種をまく。', '古英語 sawan(まく)。', { syn: [{ w: 'plant', m: '植える' }, { w: 'scatter', m: 'まき散らす' }], ant: [{ w: 'reap', m: '刈り取る' }], field: '農業' }],
]
