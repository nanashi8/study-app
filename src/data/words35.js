...
const RAW = [
  ...
  ['conscientious', '形', '1', '良心的な・誠実な', 'Mari is a conscientious student who always checks her homework twice.', 'マリはいつも宿題を2回見直す誠実な生徒だ。', 'ラテン conscientia(良心)→ science と同系。', { syn: [{ w: 'diligent', m: '勤勉な' }, { w: 'thorough', m: '入念な' }], ant: [{ w: 'negligent', m: '怠慢な' }], field: '性質・状態' }],
  ...
  ['melancholy', '形', '1', '憂うつな・物悲しい', 'The street musician played a melancholy tune on his old violin.', 'その路上演奏家は、古いバイオリンで物悲しい曲を弾いた。', 'ギリシャ melas(黒)+khole(胆汁)→黒胆汁。', { syn: [{ w: 'sad', m: '悲しい' }, { w: 'gloomy', m: '陰気な' }], ant: [{ w: 'cheerful', m: '陽気な' }], field: '心理' }],
  ...
  ['placid', '形', '1', '穏やかな・落ち着いた', 'Our placid old dog barely reacts even when the doorbell rings.', 'うちの穏やかな老犬は、玄関のベルが鳴ってもほとんど反応しない。', 'ラテン placidus(静かな)→ please と同系。', { syn: [{ w: 'calm', m: '静かな' }, { w: 'serene', m: '穏やかな' }], ant: [{ w: 'turbulent', m: '荒れた' }], field: '性質・状態' }],
