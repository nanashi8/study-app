...
// 既存の4択テスト（grammar.js）は英検級ごとだが、こちらは学年段階で並べて
// 「読んで理解する」ための解説を提供する。各レッスンは level/topic を持ち、
// grammar.js の同じ topic のテストへ接続できる（無い場合は quiz リンクを出さない）。
//
//   stage  : 学年段階（中1/中2/中3/高校基礎/高校発展）
//   title  : 単元名
//   level  : 対応する英検級（テスト接続・色分け用）
//   topic  : grammar.js の topic と一致させるとテストへ飛べる
//   summary: 一言まとめ
//   form   : 形（語順・公式）
//   points : 押さえるポイント（配列）
//   examples: 例文 [{en, ja}]
