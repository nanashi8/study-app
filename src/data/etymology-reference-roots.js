...
export const REFERENCE_ROOT_WORDS = {
  ...
  fort: ['reinforce', 'reinforcement', 'force', 'forceful', 'forcefully', 'enforce', 'enforced', 'enforcement', 'fort', 'fortify', 'fortitude', 'fortress', 'effort', 'effortless', 'comfort', 'comfortable', 'comforting'],
  ...
  arma: ['disarm', 'disarmament', 'army', 'armistice', 'arms', 'armament', 'armed', 'unarmed', 'alarm', 'alarming'],
