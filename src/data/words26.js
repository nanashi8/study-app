...
const RAW = [
  ...
  ['interface', '名', '1', 'インターフェース・接点', 'The app has a simple interface.', 'そのアプリはインターフェースが分かりやすい。', 'inter(間)+face(面)。', { syn: [{ w: 'connection', m: '接続' }], field: '技術' }],
  ...
  ['manifest', '動', '1', '明らかにする・明白な(形)', 'His actions manifested his true feelings.', '彼の行動は彼の本当の気持ちを明らかにした。', 'ラテン manifestus(手でつかめる)→ manus(手)。', { syn: [{ w: 'show', m: '示す' }, { w: 'reveal', m: '明らかにする' }], field: '動作・行為' }],
  ...
  ['preliminary', '形', '1', '予備の・準備の', 'Before the main survey, we did a preliminary study with ten students.', '本調査の前に、私たちは10人の生徒で予備調査を行った。', 'ラテン prae+limen(敷居)。', { syn: [{ w: 'initial', m: '最初の' }], ant: [{ w: 'final', m: '最終の' }], field: '性質・状態' }],
