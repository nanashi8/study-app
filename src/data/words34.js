...
const RAW = [
  ...
  ['gear', '名', 'pre1', '歯車・道具・装備', 'Please pack your camping gear before Friday.', '金曜日までにキャンプの道具を荷造りしてください。', '古ノルド gervi(装備)。', { syn: [{ w: 'equipment', m: '装備' }], field: '技術' }],
  ...
  ['wield', '動', '1', '(権力・道具を)振るう・行使する', 'They wield great power.', '彼らは大きな権力を振るっている。', '古英語 wealdan(支配する)。', { syn: [{ w: 'exercise', m: '行使する' }, { w: 'handle', m: '扱う' }], field: '動作・行為' }],
  ['render', '動', '1', '〜にする・与える・表現する', 'The shock rendered her speechless.', 'その衝撃は彼女を言葉が出ない状態にした。', 'ラテン reddere(返す)→ render。', { syn: [{ w: 'make', m: 'させる' }, { w: 'provide', m: '与える' }], field: '動作・行為' }],
  // 思考・判断の動詞
  ...
  ['postulate', '動', '1', '仮定する・要請する', 'Scientists postulated that the planet once had water.', '科学者たちは、その惑星にはかつて水があったと仮定した。', 'ラテン postulare(要求する)。', { syn: [{ w: 'assume', m: '仮定する' }, { w: 'hypothesize', m: '仮説を立てる' }], field: '科学' }],
  // 大きさの形容詞
