...
const RAW = [
  ...
  ['entitle', '動', '1', '権利を与える・題をつける', 'The ticket entitles you to entry.', 'その券があれば、入場する権利が与えられる。', 'en(〜にする)+title(資格・題)。', { syn: [{ w: 'authorize', m: '権限を与える' }], field: '法律' }],
  ...
  ['discreet', '形', '1', '思慮深い・控えめな', 'She wore a discreet black dress to the ceremony.', '彼女は式に控えめな黒いドレスを着ていった。', 'ラテン discernere(見分ける)→ discern と同系。', { syn: [{ w: 'careful', m: '慎重な' }, { w: 'tactful', m: '如才ない' }], ant: [{ w: 'indiscreet', m: '軽率な' }], field: '性質・状態' }],
  ...
  ['dormant', '形', '1', '休眠中の・活動していない', 'The volcano is dormant.', 'その火山は今は活動していない。', 'ラテン dormire(眠る)→ dormitory と同系。', { syn: [{ w: 'inactive', m: '不活発な' }, { w: 'sleeping', m: '眠っている' }], ant: [{ w: 'active', m: '活動的な' }], field: '性質・状態' }],
