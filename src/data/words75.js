...
const RAW = [
  ['pass', '動', 'pre1', '通る・可決する・合格する・手渡す', 'The bus passes my house every morning.', 'バスは毎朝私の家の前を通る。', 'ラテン passus(歩み)→ pace と同系。', { syn: [{ w: 'approve', m: '可決する' }, { w: 'go by', m: '通り過ぎる' }], ant: [{ w: 'fail', m: '落第する' }], fam: [{ w: 'passable', m: '通行可能な' }], field: '一般' }],
  ...
  ['national', '形', 'pre1', '国の・全国的な・国民', 'Our team played in the national tournament.', '私たちのチームは全国大会に出場した。', 'nation(国)+ -al。', { syn: [{ w: 'nationwide', m: '全国的な' }, { w: 'state', m: '国家の' }], ant: [{ w: 'local', m: '地方の' }], fam: [{ w: 'nation', m: '国家' }], field: '政治' }],
