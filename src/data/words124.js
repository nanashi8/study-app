...
const RAW = [
  ...
  ['elder', '名', '4', '年上の人・年長の(形)', 'In Japan, we use polite words with our elders.', '日本では年上の人に丁寧な言葉を使う。', '古英語 eldra(年上の)。', { field: '社会' }],
  ['female', '名', '4', '女性・雌・女性の(形)', 'In this kind of bird, the female builds the nest.', 'この種類の鳥では、雌が巣を作る。', 'ラテン femella(若い女)。', { field: '社会' }],
  ['male', '名', '4', '男性・雄・男性の(形)', 'The male of this bird has a red head.', 'この鳥の雄は頭が赤い。', 'ラテン masculus(男の)。', { field: '社会' }],
  ['gentleman', '名', '4', '紳士・男の方', 'A kind gentleman gave his seat to my grandmother.', '親切な紳士が祖母に席を譲ってくれた。', 'gentle(上品な)+man(人)。', { field: '社会' }],
  ['goddess', '名', '4', '女神', 'In the old story, the goddess of the sea protects the fishermen.', 'その昔話では、海の女神が漁師たちを守っている。', 'god(神)+ -ess。', { field: '宗教' }],
