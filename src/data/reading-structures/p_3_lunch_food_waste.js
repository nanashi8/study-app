...
export default Object.freeze([
  st('[S Students at one junior high school] [V noticed] [O {that節| [接 that] [S a lot of food] [V was left] [M in the cafeteria] [M after lunch]}].', {
    chunks: [
  ...
  st('[S The cooking staff] [V had to throw] [O the leftovers] [M away], [M {副詞節:譲歩| [接 even though] [S most of the food] [V was] [M still] [C fresh]}].', {
    chunks: [
  ...
  st('[S A science class] [V decided] [O {to:名詞| [V to study] [O the problem]}] [M instead of {動名詞| [M simply] [V asking] [O everyone] [C {to:補語| [V to eat] [M more]}]}].', {
    chunks: [
  ...
  st('[S Many younger students] [V said] [O {that省略| [S the usual portions] [V were] [C too large]}], [M {副詞節:対比| [接 while] [S some older students] [V wanted] [O more food] [M after sports practice]}].', {
    chunks: [
  ...
  st('[S The class] [M then] [V measured] [O the amount of rice, vegetables, and bread {過去分詞>rice, vegetables, and bread| [V left] [M each day]}] [M for two weeks].', {
    chunks: [
  ...
  st('[S They] [V discovered] [O {that節| [接 that] [S waste] [V was] [C greatest] [M on days {関係>days| [M when] [S every student] [V received] [O the same large portion]}]}].', {
    chunks: [
  ...
  st('[S The students] [V suggested] [O {動名詞| [V offering] [O two plate sizes] [M at the start of lunch]}].', {
    chunks: [
  ...
  st('[S Anyone {関係>Anyone| [S who] [V chose] [O the smaller plate]}] [V could return] [M for more food] [M later].', {
    chunks: [
  ...
  st('[S The cafeteria] [M also] [V put] [O pictures of both portions] [M near the entrance] [M {副詞節:目的| [接 so] [S students] [V could choose] [M before {動名詞| [V reaching] [O the counter]}]}].', {
    chunks: [
  ...
  st('[M After one month], [S food waste] [V was] [C almost half of the earlier amount].', {
    chunks: [
  ...
  st('[S Daily records] [V helped] [O the cooking staff] [C {to:補語| [V to prepare] [O a better amount for each menu]}].', {
    chunks: [
  ...
  st('[S The project] [V taught] [O1 them] [O2 {that節| [接 that] [S {動名詞| [V reducing] [O food waste]}] [V does not require] [O one perfect rule for everyone]}].', {
    chunks: [
  ...
  st('[S It] [V can begin] [M by {動名詞| [V giving] [O1 people] [O2 clear information and a useful choice]}].', {
    chunks: [
  ...
  st('[S The students] [M now] [V share] [O their results] [M with nearby schools] [接 and] [V encourage] [O them] [C {to:補語| [V to measure] [O their own waste]}].', {
    chunks: [
