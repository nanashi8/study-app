...
const PASSAGE_DICTIONARY_WORDS = [
  ...
  { id: 'english', word: 'English', pos: '名', level: '5', meaning: '英語・英語の(形)', field: '言語' },
  ...
  { id: 'plant', pos: '動', level: '3', meaning: '植える・植物(名)', field: '自然' },
  ...
  { id: 'farm', surface: 'farming', pos: '名', level: '3', meaning: '農場・農業を営む(動)', field: '農業', example: { en: 'We picked strawberries on a farm near our town.', ja: '私たちは町の近くの農場でイチゴを摘んだ。' } },
  ...
  { id: 'themselves', pos: '代', level: 'pre2', meaning: '彼ら自身・彼女ら自身・それら自体', field: '機能語', example: { en: 'The students planned the school trip themselves.', ja: '生徒たちは修学旅行の計画を彼ら自身で立てた。' } },
  ...
  { id: 'anyone', pos: '代', level: '3', meaning: '誰か・誰でも', field: '家族・人', example: { en: 'Anyone who chose the smaller plate could return for more food later.', ja: '小さい皿を選んだ人は誰でも、後でもっと食べ物を取りに戻ることができました。' } },
  { id: 'nobody', pos: '代', level: '3', meaning: '誰も〜ない・一人も〜ない', field: '家族・人', example: { en: 'More students finished their meals, but nobody had to remain hungry.', ja: 'より多くの生徒が食事を食べ終えましたが、空腹のままでいなければならない生徒は誰もいませんでした。' } },
  ...
  { id: 'score', surface: 'scores', pos: '名', level: '3', meaning: '得点・成績・得点する(動)', field: '教育' },
  ...
  { id: 'purchase', pos: '名', level: '2', meaning: '購入・購入品・購入する(動)', field: '経済' },
