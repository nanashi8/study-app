...
const RAW = [
  ...
  ['enumerate', '動', '1', '列挙する・数え上げる', 'He enumerated the reasons.', '彼は理由を列挙した。', { parts: [{ t: 'e', kind: 'prefix', gloss: '外へ・一つずつ' }, { t: 'numer', kind: 'root', gloss: '数える', root: 'numer' }, { t: 'ate', kind: 'suffix', gloss: '〜する' }], note: '一つずつ外へ(e)数え出す(numer)→「列挙する・数え上げる」。' }, { syn: [{ w: 'list', m: '列挙する' }, { w: 'itemize', m: '項目化する' }], fam: [{ w: 'enumeration', m: '列挙' }], field: '動作・行為' }],
