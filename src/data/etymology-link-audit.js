...
export const AUDITED_LINK_WORDS = Object.freeze({
  ...
  cert: Object.freeze(['discreet', 'discrete', 'discretion', 'discrimination']),
  ...
  nom: Object.freeze(['ignominious', 'ignominy', 'noun']),
  ...
  spect: Object.freeze(['despise', 'expectation', 'special', 'species', 'specific', 'specimen', 'spice']),
  spir: Object.freeze(['aspiration', 'aspire', 'expire']),
  sta: Object.freeze(['cost', 'establish', 'existing', 'instantly', 'obstinate', 'stability', 'stabilize', 'stage', 'statement']),
  ...
  viv: Object.freeze(['viable', 'vital', 'vitality', 'vitamin']),
