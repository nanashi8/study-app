  ...
  p_2_vertical_farming: freezeQuestions([
    {
      ...
      explain: '水を回収して再び使うので、使う水の量が少なくなります（第4文）。',
    },
    {
      ...
      explain: '照明や冷却に使う電気が化石燃料から作られるなら、輸送を短くして節約した分を打ち消すことがあります（第9文）。',
    },
    {
      ...
      explain: '第12文で、早く育つ葉物野菜やハーブが今のところ最も向いていると書かれています。',
    },
    {
      ...
      explain: 'そのしくみの一生全体を調べ、作物・季節・届け先をそろえた農場どうしで比べる必要があります。',
    },
    {
