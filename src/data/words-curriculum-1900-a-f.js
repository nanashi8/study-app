...
acoustic	形	2	音響の・音の	The hall has excellent acoustic design.	そのホールは優れた音響設計になっている。	ギリシャ語 akouein（聞く）に由来し、「聞こえる音に関する」という意味を表す。	科学
actor	名	4	俳優・行為者	The actor practiced the final scene again.	その俳優は最後の場面をもう一度練習した。	ラテン語 agere（行う）からできた act に、人を表す -or が付いた語。	芸術
...
bathroom	名	4	浴室・トイレ	The bathroom is next to the bedroom.	浴室は寝室の隣にある。	bath（入浴）＋room（部屋）の複合語。	食・生活
bean	名	3	豆	She put red beans in the salad.	彼女はサラダに赤い豆を入れた。	古英語 bean にさかのぼるゲルマン系の基本語。	食・生活
bedroom	名	4	寝室	My bedroom faces the garden.	私の寝室は庭に面している。	bed（ベッド）＋room（部屋）の複合語。	食・生活
bee	名	3	ハチ	A bee landed on the yellow flower.	一匹のハチが黄色い花にとまった。	古英語 beo にさかのぼるゲルマン系の基本語。	自然
beef	名	5	牛肉	We cooked beef and vegetables for dinner.	夕食に牛肉と野菜を調理した。	古フランス語 boef を経てラテン語 bos（牛）にさかのぼる語。	食・生活
best	形	5	最もよい・最善の	This is the best route to the station.	これが駅へ行く最もよい道です。	good の最上級に当たる古いゲルマン系の語で、語形が good から規則的には作られない。	性質・状態
better	形	5	よりよい・より上手な	This plan is better than the first one.	この案は最初の案よりよい。	good または well の比較級に当たる古いゲルマン系の語。	性質・状態
beverage	名	pre2	飲み物	Water is the most popular beverage here.	ここでは水が最もよく飲まれる飲み物だ。	古フランス語 bevrage（飲み物）を経て、「飲む」を表す語族からできた語。	食・生活
...
bored	形	4	退屈した	The children became bored during the long wait.	子どもたちは長い待ち時間に退屈した。	bore（退屈させる）の過去分詞が形容詞化し、退屈を感じる人の状態を表す。	心理
born	形	3	生まれた	She was born in a coastal town.	彼女は海辺の町で生まれた。	bear（産む）の古い過去分詞 born が、「生まれた」という形容詞的な用法で定着した。	家族・人
...
calligraphy	名	4	書道・美しい文字を書く技術	She practices Japanese calligraphy every Saturday.	彼女は毎週土曜日に日本の書道を練習する。	ギリシャ語 kallos（美）＋graphein（書く）から、「美しく書くこと」を表す。	芸術
camping	名	4	キャンプ	We went camping beside the lake.	私たちは湖のそばへキャンプに行った。	camp（野営する）＋-ing。camp はラテン語 campus（野原）につながる。	食・生活
Canada	名	5	カナダ	Canada has two official languages.	カナダには二つの公用語がある。	セントローレンス・イロコイ語 kanata（村・集落）が地名として広がった。	地理
carrot	名	5	ニンジン	Cut the carrot into thin slices.	ニンジンを薄切りにしてください。	ギリシャ語 karoton、ラテン語 carota を経て英語に入った語。	食・生活
cater	動	2	料理を提供する・要望に応える	The restaurant caters for large school events.	そのレストランは大規模な学校行事に料理を提供する。	中英語の「食料を買い付ける人」を表す語から、食事を用意する動詞へ発達した。	ビジネス
census	名	pre2	国勢調査・人口調査	The census is conducted every five years.	その人口調査は5年ごとに行われる。	ラテン語 censere（評価する・数える）から、住民を公式に数える調査を表す。	社会
...
curry	名	5	カレー料理	This vegetable curry is not very spicy.	この野菜カレーはあまり辛くない。	タミル語 kari（ソース・汁料理）を、ポルトガル語などを経て英語が取り入れた語。	料理
dad	名	4	お父さん	My dad cooks breakfast on Sundays.	私のお父さんは日曜日に朝食を作る。	幼児語の反復音から生まれた親しみのある呼び方。	家族・人
...
fourth	形	3	4番目の	The fourth chapter explains the experiment.	第4章がその実験を説明している。	four（4）に序数を作る -th が付いた語。	時間・数量
France	名	4	フランス	France is known for its varied regional cuisine.	フランスは地域ごとに多様な料理で知られる。	ゲルマン系民族 Franks（フランク人）の名から国名になった。	地理
frontier	名	pre2	国境地帯・未開拓の分野	Space science remains a frontier of research.	宇宙科学は今も研究の最前線だ。	古フランス語 frontiere（前面・境界）から、国境や新しく切り開く領域を表すようになった。	地理
fund	名	2	資金・基金	The school created a fund for student projects.	学校は生徒の企画のための基金を設けた。	ラテン語 fundus（底・基盤）を経て、事業を支える資金の蓄えを表すようになった。	経済
further	副	3	さらに・もっと遠くへ	We need to investigate the cause further.	私たちは原因をさらに調べる必要がある。	far（遠く）の比較を表す古い語形から発達し、距離だけでなく程度の追加にも使われる。	副詞
