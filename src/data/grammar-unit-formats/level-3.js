...
export const GRAMMAR_UNIT_FORMATS_3 = unitFormats('3', [
  {
    ...
    usage: [
      ['期間の長さは for、始まりは since', 'I have known Ms. Sato ___ three years.', ['for', 'since', 'from', 'during'], 'for', '私は佐藤さんと3年間の知り合いです。', '現在完了で続いている長さを言うときは for＋期間、始まった時点を言うときは since＋時を使う。', [
      ...
      ['経験をたずねる ever', 'Have you ___ visited that castle before?', ['ever', 'yet', 'already', 'still'], 'ever', 'あなたは以前にあの城を訪れたことがありますか。', '経験をたずねる疑問文では ever を過去分詞の前に置き、「今までに〜したことがありますか」とたずねる。', [
  ...
  },
  {
    ...
    usage: [
      ...
      ['know は現在完了進行形にしない', 'I have ___ her for years.', ['known', 'been knowing', 'knowing', 'know'], 'known', '私は彼女を何年も前から知っています。', 'know のように状態を表す動詞は進行形にしないので、続いていることも have known と現在完了で表す。', [
  ...
  },
  {
    ...
    usage: [
      ['おおわれているは be covered with', 'The garden is covered ___ fallen leaves.', ['with', 'by', 'of', 'from'], 'with', 'その庭は落ち葉でおおわれています。', 'be covered with 〜 で「〜でおおわれている」。動作をした人を言う by とは使い分ける。', [
      ...
      ['材料が変わるなら be made from', 'Cheese is made ___ milk.', ['from', 'of', 'with', 'by'], 'from', 'チーズは牛乳から作られます。', '見ても元が分からないほど変わる材料は be made from、形が残る材料は be made of を使う。', [
  ...
  },
  {
    ...
    usage: [
      ['〜に見えるは look＋形容詞', 'You ___ happy today.', ['look', 'look at', 'see', 'watch'], 'look', 'あなたは今日うれしそうに見えます。', 'look＋形容詞で「〜に見える」。目を向ける動作を表す look at 〜 とは形も意味もちがう。', [
      ...
      ['buy は物を先に言うと for＋人', 'My mother bought a bag ___ me.', ['for', 'to', 'of', 'with'], 'for', '母は私にかばんを買ってくれました。', 'SVOO を〈物＋前置詞＋人〉に言いかえるとき、buy・make・cook などは for、give・show・tell などは to を使う。', [
  ...
  },
  {
    ...
    usage: [
      ['let のあとに to は付けない', 'Will you let me ___ this camera?', ['try', 'to try', 'trying', 'tried'], 'try', '私にこのカメラを試させてくれませんか。', 'let＋人＋動詞の原形の形なので、原形 try の前に to を置かない。', [
      ...
      ['物が主語の make＋O＋原形', 'This story makes me ___ sad.', ['feel', 'to feel', 'feeling', 'felt'], 'feel', 'この物語は私を悲しい気持ちにさせます。', '物が主語でも make＋目的語＋動詞の原形の形は変わらない。feel sad で「悲しい気持ちになる」。', [
      ...
      ['手伝うは help＋人＋原形', 'She helped her brother ___ his homework.', ['finish', 'finished', 'finishes', 'to finishing'], 'finish', '彼女は弟が宿題を終えるのを手伝いました。', 'help＋人＋動詞の原形で「人が〜するのを手伝う」。人のあとは原形 finish にする。', [
  ...
  },
  {
    ...
    usage: [
      ['keep のあとは動名詞', 'He kept ___ for an hour.', ['talking', 'to talk', 'talk', 'talked'], 'talking', '彼は1時間話し続けました。', 'keep のあとに動作を置くときは動詞ing にする。keep talking で「話し続ける」となる。', [
      ...
      ['promise のあとは to＋原形', 'She promised ___ her room every day.', ['to clean', 'cleaning', 'clean', 'to cleaning'], 'to clean', '彼女は毎日部屋をそうじすると約束しました。', 'promise のあとに「〜すること」を置くときは to＋動詞の原形にして to clean とする。', [
  ...
  },
  {
    ...
    usage: [
      ...
      ['「〜かどうか」は if で表す', 'I don’t know ___ he will come today.', ['if', 'that', 'what', 'who'], 'if', '私は彼が今日来るかどうか分かりません。', '「〜かどうか」を文の中に入れるときは if（または whether）でつなぐ。', [
  ...
  },
  {
    ...
    usage: [
      ['人の気持ちは過去分詞', 'We were ___ at the sudden news.', ['surprised', 'surprising', 'surprise', 'to surprise'], 'surprised', '私たちはその突然の知らせに驚きました。', '人が驚かされる側なので過去分詞 surprised を使う。物事の性質を表すときは surprising になる。', [
      ...
      ['物事の性質は現在分詞', 'That movie was very ___.', ['exciting', 'excited', 'excite', 'to excite'], 'exciting', 'その映画はとてもわくわくするものでした。', '映画は人をわくわくさせる側なので現在分詞 exciting を使う。人の気持ちは excited になる。', [
  ...
  },
  {
    ...
    usage: [
      ['比較級を強めるのは much', 'This book is ___ easier than that one.', ['much', 'very', 'so', 'too'], 'much', 'この本はあの本よりずっとやさしいです。', '比較級を「ずっと」と強めるときは much を使う。very は原級を強める語で、比較級には付けない。', [
  ...
  },
  {
    ...
    usage: [
      ...
      ['気持ちのあとは that＋文', 'I’m ___ that many people will use robots.', ['sure', 'surely', 'sureness', 'surer'], 'sure', '多くの人がロボットを使うようになると私は確信しています。', 'be sure that 〜 で「〜だと確信している」。that のあとには〈主語＋動詞〉の文を置く。', [
  ...
  },
  {
    ...
    usage: [
      ['while のあとは〈主語＋動詞〉', 'Nobody spoke ___ the movie was playing.', ['while', 'during', 'for', 'in'], 'while', '映画が上映されている間、だれも話しませんでした。', 'while は接続詞なので後ろに〈主語＋動詞〉を置く。名詞だけを続けるときは during を使う。', [
      ...
      ['prevent＋人＋from＋動名詞', 'The snow prevented them ___ going out.', ['from', 'to', 'of', 'for'], 'from', '雪のせいで彼らは外出できませんでした。', 'prevent＋人＋from＋動詞ing で「人が〜するのをさまたげる」という決まった形になる。', [
