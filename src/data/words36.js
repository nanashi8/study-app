...
const RAW = [
  ...
  ['suppress', '動', '1', '抑圧する・抑える', 'He suppressed a laugh.', '彼は笑いを抑えた。', 'ラテン sub+premere(押す)→ press と同系。', { syn: [{ w: 'restrain', m: '抑える' }, { w: 'stifle', m: '抑制する' }], ant: [{ w: 'express', m: '表す' }], field: '動作・行為' }],
  ...
  ['mandate', '名', '1', '権限・命令・任期', 'The government has a clear mandate.', '政府は国民から明確な権限を与えられている。', 'ラテン manus(手)+dare(与える)→手渡す。', { syn: [{ w: 'authority', m: '権限' }, { w: 'order', m: '命令' }], field: '政治' }],
