...
export const KANBUN_KUNDOKU_EXERCISES = Object.freeze([
  freezeExercise({
    ...
    marked: '読㆑書', tokens: [{ id: 'read', label: '読' }, { id: 'book', label: '書' }], order: ['book', 'read'],
  ...
  freezeExercise({
    ...
    marked: '不㆑知', tokens: [{ id: 'not', label: '不' }, { id: 'know', label: '知' }], order: ['know', 'not'],
  ...
  freezeExercise({
    ...
    marked: '愛㆑人', tokens: [{ id: 'love', label: '愛' }, { id: 'people', label: '人' }], order: ['people', 'love'],
  ...
  freezeExercise({
    ...
    marked: '不㆑可㆑忘', tokens: [{ id: 'not', label: '不' }, { id: 'can', label: '可' }, { id: 'forget', label: '忘' }], order: ['forget', 'can', 'not'],
  ...
  freezeExercise({
    ...
    marked: '学㆓於師㆒', tokens: [{ id: 'learn', label: '学' }, { id: 'at', label: '於' }, { id: 'teacher', label: '師' }], order: ['teacher', 'at', 'learn'],
  ...
  freezeExercise({
    ...
    marked: '読㆓古書㆒', tokens: [{ id: 'read', label: '読' }, { id: 'old', label: '古' }, { id: 'book', label: '書' }], order: ['old', 'book', 'read'],
  ...
  freezeExercise({
    ...
    marked: '問㆓道於師㆒', tokens: [{ id: 'ask', label: '問' }, { id: 'way', label: '道' }, { id: 'at', label: '於' }, { id: 'teacher', label: '師' }], order: ['way', 'teacher', 'at', 'ask'],
  ...
  freezeExercise({
    ...
    marked: '此事可㆑行', tokens: [{ id: 'this', label: '此' }, { id: 'matter', label: '事' }, { id: 'can', label: '可' }, { id: 'do', label: '行' }], order: ['this', 'matter', 'do', 'can'],
  ...
  freezeExercise({
    ...
    marked: '未㆑見㆓其人㆒', tokens: [{ id: 'notyet1', label: '未①' }, { id: 'see', label: '見' }, { id: 'that', label: '其' }, { id: 'person', label: '人' }, { id: 'notyet2', label: '未②' }], order: ['notyet1', 'that', 'person', 'see', 'notyet2'],
  ...
  freezeExercise({
    ...
    marked: '学而時習㆑之', tokens: [{ id: 'learn', label: '学' }, { id: 'and', label: '而' }, { id: 'time', label: '時' }, { id: 'practice', label: '習' }, { id: 'it', label: '之' }], order: ['learn', 'and', 'time', 'it', 'practice'],
  ...
  freezeExercise({
    ...
    marked: '使㆓人読㆒㆑書', tokens: [{ id: 'make', label: '使' }, { id: 'person', label: '人' }, { id: 'read', label: '読' }, { id: 'book', label: '書' }], order: ['person', 'book', 'read', 'make'],
  ...
  freezeExercise({
    ...
    marked: '欲㆓学㆒㆑道', tokens: [{ id: 'want', label: '欲' }, { id: 'learn', label: '学' }, { id: 'way', label: '道' }], order: ['way', 'learn', 'want'],
  ...
  freezeExercise({
    ...
    marked: '欲㆘使㆓人読㆒㆑書㆖', tokens: [{ id: 'want', label: '欲' }, { id: 'make', label: '使' }, { id: 'person', label: '人' }, { id: 'read', label: '読' }, { id: 'book', label: '書' }], order: ['person', 'book', 'read', 'make', 'want'],
  ...
  freezeExercise({
    ...
    marked: '身為㆓宋国笑㆒', tokens: [{ id: 'self', label: '身' }, { id: 'become', label: '為' }, { id: 'song', label: '宋国' }, { id: 'laugh', label: '笑' }], order: ['self', 'song', 'laugh', 'become'],
  ...
  freezeExercise({
    ...
    marked: '何以知㆑之', tokens: [{ id: 'what', label: '何' }, { id: 'with', label: '以' }, { id: 'know', label: '知' }, { id: 'it', label: '之' }], order: ['what', 'with', 'it', 'know'],
  ...
  freezeExercise({
    ...
    marked: '不㆓亦説㆒乎', tokens: [{ id: 'not', label: '不' }, { id: 'also', label: '亦' }, { id: 'joyful', label: '説' }, { id: 'question', label: '乎' }], order: ['also', 'joyful', 'not', 'question'],
  ...
  freezeExercise({
    ...
    marked: '百聞不㆑如㆓一見㆒', tokens: [{ id: 'manyhears', label: '百聞' }, { id: 'not', label: '不' }, { id: 'compare', label: '如' }, { id: 'onesee', label: '一見' }], order: ['manyhears', 'onesee', 'compare', 'not'],
  ...
  freezeExercise({
    ...
    marked: '日将㆑暮', tokens: [{ id: 'sun', label: '日' }, { id: 'soon1', label: '将①' }, { id: 'dark', label: '暮' }, { id: 'soon2', label: '将②' }], order: ['sun', 'soon1', 'dark', 'soon2'],
  ...
  freezeExercise({
    ...
    marked: '将㆘使㆓民守㆒㆑礼㆖', tokens: [{ id: 'soon1', label: '将①' }, { id: 'make', label: '使' }, { id: 'people', label: '民' }, { id: 'keep', label: '守' }, { id: 'ritual', label: '礼' }, { id: 'soon2', label: '将②' }], order: ['soon1', 'people', 'ritual', 'keep', 'make', 'soon2'],
  ...
  freezeExercise({
    ...
    marked: '学而不㆑思則罔', tokens: [{ id: 'learn', label: '学' }, { id: 'but', label: '而' }, { id: 'not', label: '不' }, { id: 'think', label: '思' }, { id: 'then', label: '則' }, { id: 'blind', label: '罔' }], order: ['learn', 'but', 'think', 'not', 'then', 'blind'],
  ...
  freezeExercise({
    ...
    marked: '王使㆓臣守㆒㆑城', tokens: [{ id: 'king', label: '王' }, { id: 'make', label: '使' }, { id: 'vassal', label: '臣' }, { id: 'guard', label: '守' }, { id: 'castle', label: '城' }], order: ['king', 'vassal', 'castle', 'guard', 'make'],
  ...
  freezeExercise({
    ...
    marked: '臣見㆑疑於王', tokens: [{ id: 'vassal', label: '臣' }, { id: 'passive', label: '見' }, { id: 'doubt', label: '疑' }, { id: 'by', label: '於' }, { id: 'king', label: '王' }], order: ['vassal', 'king', 'by', 'doubt', 'passive'],
  ...
  freezeExercise({
    ...
    marked: '匹夫尚不㆑可㆑奪㆑志、況君子乎', tokens: [{ id: 'ordinary', label: '匹夫' }, { id: 'even', label: '尚' }, { id: 'not', label: '不' }, { id: 'can', label: '可' }, { id: 'take', label: '奪' }, { id: 'will', label: '志' }, { id: 'muchmore', label: '況' }, { id: 'gentleman', label: '君子' }, { id: 'question', label: '乎' }], order: ['ordinary', 'even', 'will', 'take', 'can', 'not', 'muchmore', 'gentleman', 'question'],
  ...
  freezeExercise({
    ...
    marked: '青取㆓之於藍㆒而青㆓於藍㆒', tokens: [{ id: 'blue1', label: '青①' }, { id: 'take', label: '取' }, { id: 'it', label: '之' }, { id: 'from', label: '於' }, { id: 'indigo1', label: '藍①' }, { id: 'but', label: '而' }, { id: 'blue2', label: '青②' }, { id: 'than', label: '於' }, { id: 'indigo2', label: '藍②' }], order: ['blue1', 'it', 'indigo1', 'from', 'take', 'but', 'indigo2', 'than', 'blue2'],
  ...
  freezeExercise({
    ...
    marked: '与㆓其生而無㆒㆑義、寧死而守㆑節', tokens: [{ id: 'ratherthan', label: '与' }, { id: 'that', label: '其' }, { id: 'live', label: '生' }, { id: 'but1', label: '而' }, { id: 'no', label: '無' }, { id: 'justice', label: '義' }, { id: 'rather', label: '寧' }, { id: 'die', label: '死' }, { id: 'but2', label: '而' }, { id: 'keep', label: '守' }, { id: 'integrity', label: '節' }], order: ['that', 'live', 'but1', 'justice', 'no', 'ratherthan', 'rather', 'die', 'but2', 'integrity', 'keep'],
  ...
  freezeExercise({
    ...
    marked: '賢者不㆓必富㆒', tokens: [{ id: 'wise', label: '賢者' }, { id: 'not', label: '不' }, { id: 'always', label: '必' }, { id: 'rich', label: '富' }], order: ['wise', 'always', 'rich', 'not'],
  ...
  freezeExercise({
    ...
    marked: '善莫㆑大㆓於改㆒㆑過', tokens: [{ id: 'good', label: '善' }, { id: 'none', label: '莫' }, { id: 'great', label: '大' }, { id: 'than', label: '於' }, { id: 'correct', label: '改' }, { id: 'mistake', label: '過' }], order: ['good', 'mistake', 'correct', 'than', 'great', 'none'],
  ...
  freezeExercise({
    ...
    marked: '若不㆑学則不㆑知', tokens: [{ id: 'if', label: '若' }, { id: 'not1', label: '不①' }, { id: 'learn', label: '学' }, { id: 'then', label: '則' }, { id: 'not2', label: '不②' }, { id: 'know', label: '知' }], order: ['if', 'learn', 'not1', 'then', 'know', 'not2'],
  ...
  freezeExercise({
    ...
    marked: '雖㆑学而不㆑思', tokens: [{ id: 'although', label: '雖' }, { id: 'learn', label: '学' }, { id: 'but', label: '而' }, { id: 'not', label: '不' }, { id: 'think', label: '思' }], order: ['learn', 'although', 'but', 'think', 'not'],
  ...
  freezeExercise({
    ...
    marked: '人無㆑不㆑愛㆓其子㆒', tokens: [{ id: 'people', label: '人' }, { id: 'none', label: '無' }, { id: 'not', label: '不' }, { id: 'love', label: '愛' }, { id: 'their', label: '其' }, { id: 'child', label: '子' }], order: ['people', 'their', 'child', 'love', 'not', 'none'],
  ...
  freezeExercise({
    ...
    marked: '欲㆚使㆘人読㆓此書㆒而知㆖㆑義㆙', tokens: [{ id: 'want', label: '欲' }, { id: 'make', label: '使' }, { id: 'person', label: '人' }, { id: 'read', label: '読' }, { id: 'this', label: '此' }, { id: 'book', label: '書' }, { id: 'and', label: '而' }, { id: 'know', label: '知' }, { id: 'meaning', label: '義' }], order: ['person', 'this', 'book', 'read', 'and', 'meaning', 'know', 'make', 'want'],
  ...
  freezeExercise({
    ...
    marked: '己所㆑不㆑欲勿㆑施於人', tokens: [{ id: 'self', label: '己' }, { id: 'thing', label: '所' }, { id: 'not1', label: '不' }, { id: 'want', label: '欲' }, { id: 'do_not', label: '勿' }, { id: 'do', label: '施' }, { id: 'to', label: '於' }, { id: 'people', label: '人' }], order: ['self', 'want', 'not1', 'thing', 'people', 'to', 'do', 'do_not'],
  ...
  freezeExercise({
    ...
    marked: '豈見㆑欺於小人乎', tokens: [{ id: 'how', label: '豈' }, { id: 'passive', label: '見' }, { id: 'deceive', label: '欺' }, { id: 'by', label: '於' }, { id: 'petty', label: '小人' }, { id: 'question', label: '乎' }], order: ['how', 'petty', 'by', 'deceive', 'passive', 'question'],
  ...
  freezeExercise({
    ...
    marked: '当㆘使㆓臣察㆒㆑民㆖', tokens: [{ id: 'should1', label: '当①' }, { id: 'make', label: '使' }, { id: 'vassal', label: '臣' }, { id: 'observe', label: '察' }, { id: 'people', label: '民' }, { id: 'should2', label: '当②' }], order: ['should1', 'vassal', 'people', 'observe', 'make', 'should2'],
  ...
  freezeExercise({
    ...
    marked: '非㆓唯利㆒㆑国、亦利㆑民', tokens: [{ id: 'not', label: '非' }, { id: 'only', label: '唯' }, { id: 'benefit1', label: '利①' }, { id: 'country', label: '国' }, { id: 'also', label: '亦' }, { id: 'benefit2', label: '利②' }, { id: 'people', label: '民' }], order: ['only', 'country', 'benefit1', 'not', 'also', 'people', 'benefit2'],
  ...
  freezeExercise({
    ...
    marked: '使㆔臣為㆓敵所㆒㆑疑', tokens: [{ id: 'make', label: '使' }, { id: 'vassal', label: '臣' }, { id: 'become', label: '為' }, { id: 'enemy', label: '敵' }, { id: 'passive', label: '所' }, { id: 'doubt', label: '疑' }], order: ['vassal', 'enemy', 'doubt', 'passive', 'become', 'make'],
  ...
  freezeExercise({
    ...
    marked: '使㆓我有㆒㆑翼、則飛而至', tokens: [{ id: 'if', label: '使' }, { id: 'me', label: '我' }, { id: 'have', label: '有' }, { id: 'wing', label: '翼' }, { id: 'then', label: '則' }, { id: 'fly', label: '飛' }, { id: 'and', label: '而' }, { id: 'arrive', label: '至' }], order: ['if', 'me', 'wing', 'have', 'then', 'fly', 'and', 'arrive'],
  ...
  freezeExercise({
    ...
    marked: '是何異㆓於刺㆑人而殺㆒㆑之', tokens: [{ id: 'this', label: '是' }, { id: 'what', label: '何' }, { id: 'differ', label: '異' }, { id: 'than', label: '於' }, { id: 'stab', label: '刺' }, { id: 'person', label: '人' }, { id: 'and', label: '而' }, { id: 'kill', label: '殺' }, { id: 'them', label: '之' }], order: ['this', 'person', 'stab', 'and', 'them', 'kill', 'than', 'what', 'differ'],
  ...
  freezeExercise({
    ...
    marked: '吾願㆞欲㆚令㆘臣使㆓民学㆒㆑礼㆖而安㆙㆑国以成㆝㆑業', tokens: [{ id: 'i', label: '吾' }, { id: 'wish', label: '願' }, { id: 'want', label: '欲' }, { id: 'order', label: '令' }, { id: 'vassal', label: '臣' }, { id: 'make', label: '使' }, { id: 'people', label: '民' }, { id: 'learn', label: '学' }, { id: 'ritual', label: '礼' }, { id: 'and', label: '而' }, { id: 'peace', label: '安' }, { id: 'country', label: '国' }, { id: 'with', label: '以' }, { id: 'achieve', label: '成' }, { id: 'work', label: '業' }], order: ['i', 'vassal', 'people', 'ritual', 'learn', 'make', 'order', 'and', 'country', 'peace', 'want', 'with', 'work', 'achieve', 'wish'],
    kakikudashi: '吾、臣をして民に礼を学ばしめ、国を安んぜんと欲し、以て業を成さんことを願ふ。', translation: '私は、家臣に民へ礼を学ばせて国を安定させたいと思い、そうして事業を成し遂げることを願う。',
    clue: '礼→学→使を一二点、礼から令へ上下点、国→安から甲乙点、最後に業→成から天地人点へ返る。',
