...
const CORE_PASSAGES = [
...

  {
    ...
    sentences: [
      p('Many museums are trying to become places where teenagers can do more than simply look at objects behind glass.', '多くの博物館は、10代の若者がガラスの向こうの展示物をただ見る以上のことができる場所になろうとしています。'),
      ...
      s('When young people take part, exhibitions feel more open, and visitors are more willing to ask questions.', '若者が参加すると、展示はより開かれたものに感じられ、来館者はより進んで質問しようとします。'),
...

  {
    ...
    sentences: [
      ...
      s('At these events, local volunteers help visitors examine broken things and, when possible, repair them.', 'こうした催しでは、地域のボランティアが、来場者が壊れた物を調べ、できる場合には修理するのを手伝います。'),

      p('A repair cafe is different from a normal repair shop.', 'リペアカフェは普通の修理店とは異なります。'),
      s('Visitors are expected to sit with volunteers and take part in the work instead of simply leaving an item at a counter.', '来場者は、ただ品物を受付に預けていくのではなく、ボランティアと一緒に座って作業に参加することが求められます。'),
      s('A volunteer may show someone how to open a lamp safely, replace a worn wire, or search for instructions online.', 'ボランティアは、ランプを安全に開ける方法や、すり減った電線を交換する方法、あるいはインターネットで説明書を探す方法を教えることもあります。'),
      ...
      s('Older residents may know how older machines were built, while younger participants may be more comfortable finding digital information.', '年配の住民は古い機械がどのように作られていたかを知っているかもしれず、一方で若い参加者のほうがデジタル情報を探すことに慣れているかもしれません。'),
...

  {
    ...
    sentences: [
      p('Societies often assume that important events will be remembered simply because they are recorded in books, archives, or digital databases.', '社会はしばしば、重要な出来事は本や記録保管所、デジタルデータベースに記録されているというだけで記憶され続けるだろうと考えます。'),
      ...
      s('The integrity of public memory is then shaped less by what is available than by what is repeatedly presented as relevant.', 'そうなると公共的記憶の健全さは、入手できるものよりも、繰り返し関連のあるものとして示されるものによって形づくられます。'),
      ...
      s('A file may still exist but become unreadable when software changes, while a searchable collection can effectively disappear if its indexing system is neglected.', 'ファイルはまだ残っていても、ソフトウェアが変われば読めなくなるかもしれません。一方、検索可能な資料群は、索引の仕組みが放置されれば事実上消えてしまうことがあります。'),
      ...
      p('This raises a difficult question about institutional responsibility.', 'これは機関の責任に関する難しい問いを提起します。'),
      ...
      s('That autonomy remains essential, but it can also be misused if institutions avoid scrutiny by describing all criticism as interference.', 'その自律性は依然として不可欠ですが、機関がすべての批判を干渉だと表現して検証を避けるなら、悪用される可能性もあります。'),
      s('A healthy culture of memory therefore requires both independence and accountability.', 'したがって健全な記憶の文化には、独立性と説明責任の両方が必要です。'),
      s('Institutions must be free to preserve uncomfortable evidence, while citizens must be able to ask how decisions about selection, description, and access are made.', '機関は不都合な証拠を自由に保存できなければなりませんが、市民は選択、記述、アクセスに関する決定がどのようになされるのかを問える必要があります。'),
      ...
      s('Accountability must consequently include transparent reasons, opportunities for challenge, and continuing efforts to hear people who were absent from the original decision.', 'そのため説明責任には、透明な理由、異議を申し立てる機会、最初の決定の場にいなかった人々の声を聞き続ける努力が含まれなければなりません。'),
      p('Such debates are rarely simple because historical meaning is often ambiguous.', '歴史的意味はしばしば曖昧であるため、そのような議論はめったに単純ではありません。'),
      s('A photograph may reveal suffering to one group and national achievement to another; a monument may be seen as heritage by some and as exclusion by others.', '一枚の写真が、ある集団には苦しみを、別の集団には国の偉業を示すかもしれません。記念碑は、ある人々には遺産と見なされ、別の人々には排除の象徴と見なされるかもしれません。'),
      ...
      p('Education plays a central role in sustaining that discipline, but the task is more demanding than adding a few historical dates to a curriculum.', '教育はその規律を維持する上で中心的な役割を果たしますが、その課題はカリキュラムにいくつかの歴史的な日付を加えるよりも難しいものです。'),
      ...
      s('Two historians may accept the same evidence yet assign different significance to it because they ask different questions.', '二人の歴史家が同じ証拠を受け入れても、立てる問いが違うために、その証拠に異なる重要性を与えることがあります。'),
      s('The discipline lies in explaining those choices, confronting contrary evidence, and stating where certainty ends.', 'その規律とは、そうした選択を説明し、反対の証拠と向き合い、確実に言えるのはどこまでかを示すことにあります。'),
      s('At the same time, they need intellectual habits that prevent skepticism from turning into cynicism.', '同時に、生徒たちには、懐疑が冷笑へと変わるのを防ぐ知的な習慣も必要です。'),
      ...
      p('Digital platforms intensify this risk because they reward speed, emotional certainty, and loyalty to a group more readily than patient investigation.', 'デジタルプラットフォームは、粘り強い調査よりも、速さや感情的な確信、集団への忠誠に報いやすいため、この危険を強めます。'),
      s('A rumor that confirms a community\'s self-image may travel farther than a well-documented study that complicates it.', '共同体の自己イメージを裏づけるうわさは、その自己イメージを複雑にする、根拠のしっかりした研究よりも遠くまで広がるかもしれません。'),
      ...
      s('Although such action can limit obvious fabrications, it also gives private companies substantial authority over public memory.', 'そうした対応は明らかな捏造を抑えられるものの、民間企業に公共的記憶に対する大きな権限を与えることにもなります。'),
      s('The alternative is not to abandon moderation, but to combine it with accessible evidence, independent review, and explanations that users can examine rather than merely obey.', '代案は管理をやめることではなく、それを入手しやすい証拠や独立した審査、そして利用者がただ従うのではなく検討できる説明と組み合わせることです。'),
      ...
      s('This civic dimension explains why collective memory cannot be measured only by the number of documents preserved or people reached.', 'この市民的な側面は、集合的記憶が、保存された文書の数や情報が届いた人の数だけでは測れない理由を説明しています。'),
