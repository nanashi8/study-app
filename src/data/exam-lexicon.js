...
const RAW_EXAM_WORDS = [
  ...
  ['parameter', '名', 'pre1', '変数・制約条件・媒介変数', 'We changed one parameter at a time.', '私たちは一度に一つの変数だけを変えた。', 'ギリシャ語 para-(そばに)＋metron(測るもの)。', '測定', 'set / change a parameter「条件を設定／変更する」。複数形は parameters。'],
  ...
  ['hydroelectric', '形', 'pre1', '水力発電の', 'The dam supplies hydroelectric power to nearby towns.', 'そのダムは近くの町に水力発電の電気を供給している。', 'hydro-(水)＋electric(電気の)。', '環境', 'hydroelectric power / plant「水力発電／水力発電所」。'],
  ...
  ['rhetoric', '名', 'pre1', '修辞・説得的言説・美辞麗句', 'The speech used powerful rhetoric but offered few details.', 'その演説は力強い修辞を用いたが、具体策はほとんど示さなかった。', 'ギリシャ語 rhetor(演説家)から。', '言語', 'political rhetoric「政治的言説」、rhetorical device「修辞技法」。文脈により空疎な美辞の含み。'],
