...
export const CURRENT_AFFAIRS_READING_GRAMMAR_EXPECTATIONS = Object.freeze({
  ...
  p_3_ai_class_rules: patterns(`
    SVO SVO SVO SVO SV SVOC SVO SVO SVO SVO SVO SVO SV SVO SVO SVO SVO SVO SVOC
  ...
  p_1_synthetic_media_trust: patterns(`
    SVO SV SV SVO SVOC SVO SV SVC SVO SVC SVO SVO SVO SV SV SVO SVOC SVO SV SVC
    SV SV SVOO SVC SVO SVO SVO SVO SVC SVO SVO SVC SVO SVO SVO SVC SVO SV SVOC
    SVC SVC SV SVOC SVO SV SVC SVC SVOO SV SVO SV SVO SVO SVC SVO SV
  `),
})
