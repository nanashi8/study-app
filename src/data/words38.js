...
const RAW = [
  ...
  ['inception', '名', '1', '始まり・発端', 'The charity has helped thousands of children since its inception in 1995.', 'その慈善団体は、1995年の発足以来、何千人もの子どもたちを助けてきた。', 'ラテン in+capere(取る)→ cept と同系。', { syn: [{ w: 'beginning', m: '始まり' }, { w: 'start', m: '開始' }], ant: [{ w: 'conclusion', m: '終了' }], field: '一般' }],
  ['influx', '名', '1', '流入・殺到', 'The town saw a sudden influx of tourists after the movie became popular.', 'その映画が人気になった後、町には観光客が急に殺到した。', 'ラテン in+fluere(流れる)→ flux と同系。', { syn: [{ w: 'inflow', m: '流入' }], ant: [{ w: 'exodus', m: '流出' }], field: '社会' }],
  ['exodus', '名', '1', '大量流出・脱出', 'There is an exodus of young people from rural areas to big cities.', '地方から大都市へ、若者の大量流出が起きている。', 'ギリシャ ex(外へ)+hodos(道)。', { syn: [{ w: 'departure', m: '退去' }, { w: 'migration', m: '移住' }], ant: [{ w: 'influx', m: '流入' }], field: '社会' }],
  // 判断・性質の形容詞
  ['impending', '形', '1', '差し迫った', 'Everyone in the office was nervous about the impending job cuts.', '差し迫った人員削減に、会社のだれもが不安を感じていた。', 'ラテン im+pendere(垂れ下がる)→ pend と同系。', { syn: [{ w: 'imminent', m: '切迫した' }, { w: 'looming', m: '迫りくる' }], field: '性質・状態' }],
  ...
  ['cynical', '形', '1', '皮肉な・人を信じない', 'She has a cynical view of politics.', '彼女は政治を皮肉な目で見ている。', 'ギリシャ kynikos(犬のような)→犬のように質素に生きた学派。', { syn: [{ w: 'pessimistic', m: '悲観的な' }, { w: 'distrustful', m: '不信の' }], ant: [{ w: 'optimistic', m: '楽観的な' }], fam: [{ w: 'cynicism', m: '皮肉' }, { w: 'cynic', m: '皮肉屋' }], field: '心理' }],
