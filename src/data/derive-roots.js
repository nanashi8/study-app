...
const DENY = {
  ...
  port: ['portray','portrait','portion','proportion','proportional','portend','portent','portentous','portly'],
  spect: ['spice'],
  pos: ['ponder','ponderous','pond','postulate'],
  fer: ['ferocious','ferociously','fervent','fervor','fervently','fervid','effervescent'],
  cept: ['capital','captain','cape','capricious','capitulate','recapitulate'],
  miss: ['mitigate','enmity','miss','missing'],
  vis: ['divide','dividend','division','divisible','viscous'],
  tain: ['taint','tainted'],
  fact: ['fiction','fictional','fickle','face','facade','superficial','efface','facetious','facile','interface'],
  mot: ['mother','moth'],
  gen: ['cogent'],
  // 追加語根の除外（同綴り・別語源）
  aud: ['audacious','audacity'],
  form: ['former','formerly','formidable'],
  ...
  fund: ['found','confound','confounded'],
