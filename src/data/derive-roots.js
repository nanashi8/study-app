...
const DENY = {
  ...
  port: ['portray','portrait','portion','proportion','proportional','portend','portent','portentous','portly','opportunity'],
  spect: ['spice'],
  ...
  cept: ['capital','captain','cape','capricious','capitulate','recapitulate','recap'],
  ...
  prob: ['provoke','provide','provision','provisional','provincial','provocation','province','provident','providence','problem','problematic','improve','improvement'],
  quer: ['querulous'],
