...
const RAW = [
  ...
  ["bottle","名","4","びん・ボトル","A bottle of water, please.","ボトル入りの水を1本ください。","ラテン buttis(樽)。",{"field":"一般"}],
  ...
  ["evening","名","5","夕方・晩","I usually take a walk in the evening.","私はたいてい夕方に散歩をする。","古英語 ǣfnung「夕暮れ」。",{"ant":[{"w":"morning","m":"朝"}],"field":"一般"}],
