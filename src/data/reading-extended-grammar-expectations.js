...
export const EXTENDED_READING_GRAMMAR_EXPECTATIONS = Object.freeze({
  p_ext_4000_generational_city: patterns(`
    ...
    SVO  SVO  SVO  SV   SV   SV   SVO  SVC
    SVC  SVO  SVO  SVO  SVC  SVO  SVO  SVC  SVO  SVC  SVO  SVC
    SVO  SVO  SVO  SV   SVC  SVO  SVO  SVO
    SV   SV   SVC  SV   SVC  SVO  SVO  SVO  SVC  SVO  SVC  SVO
    SVO  SV   SVC  SVO  SVO  SVC  SVO  SVC
    SVC  SVO  SVC  SVC  SVC  SVC  SVO  SVC  SVO  SVO  SVO  SVO
    SVC  SV   SVO  SVC  SVO  SVO  SVO  SVC
    SVC  SV   SVC  SVO  SV   SVO  SV   SVO  SVO  SVO  SVC  SVC
    SV   SVO  SVO  SVO  SV   SVC  SVC  SVO
    SVO  SVO  SV   SVO  SVO  SV   SVO  SVC  SVC  SVO  SVO  SVC
    SV   SVO  SVO  SVO  SV   SV   SVC  SVO
    SV   SVO  SV   SVC  SVC  SV   SVO  SVO  SVC  SV   SVO  SVO
    SVO  SVO  SVO  SVC  SVO  SVC  SVO  SV
    SVO  SVC  SVC  SVC  SVO  SVC  SVC  SVC  SV   SVO  SVC  SV
  ...
  p_ext_3000_shared_watershed: patterns(`
    ...
    SVC  SV   SVO  SV   SVO  SVO  SVC  SVC  SVO  SVO  SVO  SVO
    SVO  SV   SVC  SVC  SVO  SVC  SV   SVC
    SVC  SVO  SVO  SVO  SVC  SVO  SVC  SVC  SVO  SVO  SVO  SVC
    SV   SVOC SVO  SV   SVC  SV   SVC  SVC
    SV   SVO  SVC  SVO  SV   SVO  SVC  SVC  SVOC SVOC SVO  SV
    SVO  SVO  SVC  SVO  SVOC SVC  SVC  SVO
