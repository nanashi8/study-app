...
const RAW = [
  ...
  ['confine', '動', '1', '閉じ込める・限定する', 'The dog was confined to a small cage all day.', 'その犬は一日中、小さなおりに閉じ込められていた。', 'ラテン con+finis(境界)→ finish と同系。', { syn: [{ w: 'restrict', m: '制限する' }, { w: 'imprison', m: '監禁する' }], ant: [{ w: 'free', m: '解放する' }], field: '動作・行為' }],
  ...
  ['immaculate', '形', '1', '汚れのない・完璧な', 'The kitchen was immaculate.', '台所はほこり一つなかった。', 'ラテン in(否定)+macula(しみ)。', { syn: [{ w: 'spotless', m: '無垢の' }, { w: 'pristine', m: '新品同様の' }], ant: [{ w: 'filthy', m: '汚れた' }], field: '性質・状態' }],
