...
No problem.	4	問題ありません・どういたしまして	Can you help me? No problem.	手伝ってくれますか。もちろんです。	conversation	くだけた会話表現。改まった場面のお礼の返事には You're welcome. などを使う。	(There is) no problem(問題はない)。頼みに対して問題ないと答えることから「いいですよ」、お礼に対して手間ではなかったと答えることから「どういたしまして」。
