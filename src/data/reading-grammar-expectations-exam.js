...
export const EXAM_READING_GRAMMAR_EXPECTATIONS = Object.freeze({
  ...
  p_pre2_later_school_start: patterns(`
    SV SVO SVO SVO SVO SVO SV SVO SVO SV SV SVO SVOC SVC SVO SVOO SVO SVC SVO SVC
  `),
  p_pre2plus_city_bird_count: patterns(`
    SV SVO SVOC SVO SVO SVO SVO SVO SVO SVO SVO SVO SVO SVOC SVO SVOO SVO SVC
    SVO SVO SVO SVO
  `),
