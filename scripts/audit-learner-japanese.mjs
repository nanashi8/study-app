...
const FORBIDDEN_GUIDANCE = [
  ...
  ['もどる', '操作名は「戻る」に統一する'],
  // 生徒の学習に関係しない、教材やアプリ自身についての説明（2026-09-16に全画面から削除）。
  ['権利を確認', '権利処理の説明は学習に関係しない'],
  ['著作権の確認', '権利処理の説明は学習に関係しない'],
  ['パブリックドメイン', '権利処理の説明は学習に関係しない'],
  ['出典表示', '出典の有無は学習に関係しない'],
  ['出典を確認した', '出典確認の手順は学習に関係しない'],
  ['参考文献', '論文の書誌は学習に関係しない'],
  ['本アプリ独自', '教材の作り手の説明は学習に関係しない'],
  ['アプリ独自の', '教材の作り手の説明は学習に関係しない'],
  ['オリジナル問題', '作問の出どころは学習に関係しない'],
  ['音声合成です', '音声の仕組みは学習に関係しない'],
  ['合成音声を使用', '音声の仕組みは学習に関係しない'],
  ['書き取り問題はありません', '試験に無い形式だという断り書きは学習に関係しない'],
  ['公式試験の偏差値', '公式試験ではないという注意書きは学習に関係しない'],
  ['IQではありません', '能力検査ではないという注意書きは学習に関係しない'],
  ['監査済み例文で確かめ', '品質管理の内部状態を学習者へ見せている'],
  ['確認済み・関連', '品質管理の内部状態を学習者へ見せている'],
  ['以前のアプリで', 'アプリの版の経緯は学習に関係しない'],
  ['単語帳に引き継ぎ', 'データ移行の経緯は学習に関係しない'],
  ['維持確認します', '復習間隔の内部方針を学習者へ見せている'],
  ['数値の食い違いを防ぐ', '記録処理の内部事情を学習者へ見せている'],
  ['折り返しても離れません', '表示の作りの説明は学習に関係しない'],
  ['厳選テーマ', '宣伝の言い回しは学習に関係しない'],
  ['英語アプリ v', 'アプリの版表記は学習に関係しない'],
]
