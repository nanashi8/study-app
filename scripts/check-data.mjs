...
if (
  ...
  readingPhrasePairCount !== 6877 ||
  readingPhraseSequenceCount !== 6877 ||
  readingMeaningPhraseCount !== 5025 ||
  readingMeaningMultiRoleCount !== 1936
) {
  errors.push(
    ...
    '（現行全件は38長文・990文・2,420ブロック・5,025意味フレーズ・6,877内部SVOCM単位）',
  )
}
if (
